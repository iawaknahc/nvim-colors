...
describe("srgb", function()
  it("parse srgb", function()
    ...
    assert.are_same({ "srgb", { 1.2, 1.4, 1.6 }, 1 }, csscolor4.srgb("1.2", "1.4", "1.6", "120%"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 } }, csscolor4.srgb("-0.2", "-0.4", "-0.6"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 }, 0 }, csscolor4.srgb("-0.2", "-0.4", "-0.6", "-10%"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 }, 0 }, csscolor4.srgb("-0.2", "-0.4", "-0.6", "-0.1"))
    ...
    assert.are_same({ "srgb", { 1.2, 1.4, 1.6 }, 1 }, csscolor4.srgb("120%", "140%", "160%", "120%"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 } }, csscolor4.srgb("-20%", "-40%", "-60%"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 }, 0 }, csscolor4.srgb("-20%", "-40%", "-60%", "-10%"))
    assert.are_same({ "srgb", { -0.2, -0.4, -0.6 }, 0 }, csscolor4.srgb("-20%", "-40%", "-60%", "-0.1"))
  end)
end)
...
describe("hsl", function()
  it("parse hsl", function()
    ...
    assert.are_same({ "hsl", { 72, 140, 160 }, 1 }, csscolor4.hsl("432", "140", "160", "120%"))
    assert.are_same({ "hsl", { 288, 0, -60 } }, csscolor4.hsl("-72", "-40", "-60"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-72", "-40", "-60", "-10%"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-72", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hsl", { 72, 140, 160 }, 1 }, csscolor4.hsl("432deg", "140", "160", "120%"))
    assert.are_same({ "hsl", { 288, 0, -60 } }, csscolor4.hsl("-72deg", "-40", "-60"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-72deg", "-40", "-60", "-10%"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-72deg", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hsl", { 72, 140, 160 }, 1 }, csscolor4.hsl("480grad", "140", "160", "120%"))
    assert.are_same({ "hsl", { 288, 0, -60 } }, csscolor4.hsl("-80grad", "-40", "-60"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-80grad", "-40", "-60", "-10%"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-80grad", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hsl", { 72, 140, 160 }, 1 }, csscolor4.hsl("1.2turn", "140", "160", "120%"))
    assert.are_same({ "hsl", { 288, 0, -60 } }, csscolor4.hsl("-0.2turn", "-40", "-60"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-0.2turn", "-40", "-60", "-10%"))
    assert.are_same({ "hsl", { 288, 0, -60 }, 0 }, csscolor4.hsl("-0.2turn", "-40", "-60", "-0.1"))
...
describe("hwb", function()
  it("parse hwb", function()
    ...
    assert.are_same({ "hwb", { 72, 140, 160 }, 1 }, csscolor4.hwb("432", "140", "160", "120%"))
    assert.are_same({ "hwb", { 288, -40, -60 } }, csscolor4.hwb("-72", "-40", "-60"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-72", "-40", "-60", "-10%"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-72", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hwb", { 72, 140, 160 }, 1 }, csscolor4.hwb("432deg", "140", "160", "120%"))
    assert.are_same({ "hwb", { 288, -40, -60 } }, csscolor4.hwb("-72deg", "-40", "-60"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-72deg", "-40", "-60", "-10%"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-72deg", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hwb", { 72, 140, 160 }, 1 }, csscolor4.hwb("480grad", "140", "160", "120%"))
    assert.are_same({ "hwb", { 288, -40, -60 } }, csscolor4.hwb("-80grad", "-40", "-60"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-80grad", "-40", "-60", "-10%"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-80grad", "-40", "-60", "-0.1"))
    ...
    assert.are_same({ "hwb", { 72, 140, 160 }, 1 }, csscolor4.hwb("1.2turn", "140", "160", "120%"))
    assert.are_same({ "hwb", { 288, -40, -60 } }, csscolor4.hwb("-0.2turn", "-40", "-60"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-0.2turn", "-40", "-60", "-10%"))
    assert.are_same({ "hwb", { 288, -40, -60 }, 0 }, csscolor4.hwb("-0.2turn", "-40", "-60", "-0.1"))
...
describe("lab", function()
  it("parse lab", function()
    ...
    assert.are_same({ "lab", { 100, 175, 200 }, 1 }, csscolor4.lab("120", "175", "200", "120%"))
    assert.are_same({ "lab", { 0, -50, -75 } }, csscolor4.lab("-20", "-50", "-75"))
    assert.are_same({ "lab", { 0, -50, -75 }, 0 }, csscolor4.lab("-20", "-50", "-75", "-10%"))
    assert.are_same({ "lab", { 0, -50, -75 }, 0 }, csscolor4.lab("-20", "-50", "-75", "-0.1"))
    ...
    assert.are_same({ "lab", { 100, 175, 200 }, 1 }, csscolor4.lab("120%", "140%", "160%", "120%"))
    assert.are_same({ "lab", { 0, -50, -75 } }, csscolor4.lab("-20%", "-40%", "-60%"))
    assert.are_same({ "lab", { 0, -50, -75 }, 0 }, csscolor4.lab("-20%", "-40%", "-60%", "-10%"))
    assert.are_same({ "lab", { 0, -50, -75 }, 0 }, csscolor4.lab("-20%", "-40%", "-60%", "-0.1"))
  end)
end)
...
describe("lch", function()
  it("parse lch", function()
    ...
    assert.are_same({ "lch", { 100, 240, 72 }, 1 }, csscolor4.lch("140", "240", "432", "120%"))
    assert.are_same({ "lch", { 0, 0, 288 } }, csscolor4.lch("-40", "-90", "-72"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-72", "-10%"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-72", "-0.1"))
    ...
    assert.are_same({ "lch", { 100, 240, 72 }, 1 }, csscolor4.lch("140", "240", "432deg", "120%"))
    assert.are_same({ "lch", { 0, 0, 288 } }, csscolor4.lch("-40", "-90", "-72deg"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-72deg", "-10%"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-72deg", "-0.1"))
    ...
    assert.are_same({ "lch", { 100, 240, 72 }, 1 }, csscolor4.lch("140", "240", "480grad", "120%"))
    assert.are_same({ "lch", { 0, 0, 288 } }, csscolor4.lch("-40", "-90", "-80grad"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-80grad", "-10%"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-80grad", "-0.1"))
    ...
    assert.are_same({ "lch", { 100, 240, 72 }, 1 }, csscolor4.lch("140", "240", "0.2turn", "120%"))
    assert.are_same({ "lch", { 0, 0, 288 } }, csscolor4.lch("-40", "-90", "-0.2turn"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-0.2turn", "-10%"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40", "-90", "-0.2turn", "-0.1"))
    ...
    assert.are_same({ "lch", { 100, 240, 72 }, 1 }, csscolor4.lch("140%", "160%", "432", "120%"))
    assert.are_same({ "lch", { 0, 0, 288 } }, csscolor4.lch("-40%", "-60%", "-72"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40%", "-60%", "-72", "-10%"))
    assert.are_same({ "lch", { 0, 0, 288 }, 0 }, csscolor4.lch("-40%", "-60%", "-72", "-0.1"))
  end)
end)
