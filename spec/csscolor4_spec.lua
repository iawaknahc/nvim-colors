...
describe("named_color", function()
  it("should return transparent", function()
    assert.same_color({ "rgb", { 0, 0, 0 }, 0 }, csscolor4.named_color("transparent"))
  end)

  it("should return correct rgb values for basic named colors", function()
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.named_color("white"))
    assert.same_color({ "rgb", { 0, 0, 0 } }, csscolor4.named_color("black"))
    assert.same_color({ "rgb", { 255, 0, 0 } }, csscolor4.named_color("red"))
    assert.same_color({ "rgb", { 0, 128, 0 } }, csscolor4.named_color("green"))
    assert.same_color({ "rgb", { 0, 0, 255 } }, csscolor4.named_color("blue"))
  end)
  ...
  it("should return correct values for complex named colors", function()
    assert.same_color({ "rgb", { 240, 248, 255 } }, csscolor4.named_color("aliceblue"))
    assert.same_color({ "rgb", { 250, 235, 215 } }, csscolor4.named_color("antiquewhite"))
    assert.same_color({ "rgb", { 127, 255, 212 } }, csscolor4.named_color("aquamarine"))
    assert.same_color({ "rgb", { 245, 245, 220 } }, csscolor4.named_color("beige"))
    assert.same_color({ "rgb", { 255, 228, 196 } }, csscolor4.named_color("bisque"))
  end)

  it("should handle CSS4 named colors", function()
    assert.same_color({ "rgb", { 102, 51, 153 } }, csscolor4.named_color("rebeccapurple"))
  end)

  it("should return correct values for additional common colors", function()
    assert.same_color({ "rgb", { 255, 255, 0 } }, csscolor4.named_color("yellow"))
    assert.same_color({ "rgb", { 0, 255, 255 } }, csscolor4.named_color("cyan"))
    assert.same_color({ "rgb", { 255, 0, 255 } }, csscolor4.named_color("magenta"))
  end)

  it("should error for unknown color names", function()
    assert.has_error(function()
      csscolor4.named_color("invalidcolor")
    end)
  end)

  it("should error for empty or nil input", function()
    assert.has_error(function()
      csscolor4.named_color("")
    end)

    assert.has_error(function()
      csscolor4.named_color(nil)
    end)
  end)
end)

describe("hex", function()
  it("should parse 3-digit hex notation", function()
    assert.same_color({ "rgb", { 0, 0, 0 } }, csscolor4.hex("#000"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("#fff"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("#FFF"))
    assert.same_color({ "rgb", { 255, 0, 0 } }, csscolor4.hex("#f00"))
    assert.same_color({ "rgb", { 0, 255, 0 } }, csscolor4.hex("#0f0"))
    assert.same_color({ "rgb", { 0, 0, 255 } }, csscolor4.hex("#00f"))
    assert.same_color({ "rgb", { 170, 187, 204 } }, csscolor4.hex("#abc"))
  end)

  it("should parse 3-digit hex notation without # prefix", function()
    assert.same_color({ "rgb", { 0, 0, 0 } }, csscolor4.hex("000"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("fff"))
    assert.same_color({ "rgb", { 255, 0, 0 } }, csscolor4.hex("f00"))
  end)

  it("should parse 6-digit hex notation", function()
    assert.same_color({ "rgb", { 0, 0, 0 } }, csscolor4.hex("#000000"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("#ffffff"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("#FFFFFF"))
    assert.same_color({ "rgb", { 255, 0, 0 } }, csscolor4.hex("#ff0000"))
    assert.same_color({ "rgb", { 0, 255, 0 } }, csscolor4.hex("#00ff00"))
    assert.same_color({ "rgb", { 0, 0, 255 } }, csscolor4.hex("#0000ff"))
    assert.same_color({ "rgb", { 170, 187, 204 } }, csscolor4.hex("#aabbcc"))
  end)

  it("should parse 6-digit hex notation without # prefix", function()
    assert.same_color({ "rgb", { 0, 0, 0 } }, csscolor4.hex("000000"))
    assert.same_color({ "rgb", { 255, 255, 255 } }, csscolor4.hex("ffffff"))
    assert.same_color({ "rgb", { 255, 0, 0 } }, csscolor4.hex("ff0000"))
  end)

  it("should parse 4-digit hex notation with alpha", function()
