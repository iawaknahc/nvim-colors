// Borrowed from https://github.com/tree-sitter/tree-sitter/blob/v0.26.8/crates/cli/npm/dsl.d.ts
// @license MIT
// @author Max Brunsfeld
// https://github.com/tree-sitter/tree-sitter/blob/v0.26.8/LICENSE
type AliasRule = {
  type: "ALIAS";
  named: boolean;
  content: Rule;
